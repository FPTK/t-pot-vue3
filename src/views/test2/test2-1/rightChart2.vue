<template>
  <div id="ver-bar">
    ...
    <div class="tit01">
      攻击来源国家 top10
      <!-- <button @click="getCountryData">攻击来源国家 top10</button> -->
    </div>
    <div id="echartVB" class="navVB"></div>
...
import { CountryData } from "@/api/system";
export default {
  components: {},
  data: function () {
    return {
  ...
  methods: {
    echartVB() {
      this.myChart = echarts.init(document.getElementById("echartVB"));
      this.options = {
        tooltip: {
          trigger: "axis",
          axisPointer: {
