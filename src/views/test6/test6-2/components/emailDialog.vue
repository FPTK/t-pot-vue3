    ...
    <el-form ref="formRef" :model="form" :rules="rules" label-width="80px">
      ...
      <el-form-item label="加密方式" prop="encryption">
        <el-radio-group v-model="radio">
          ...
          <el-radio :label="6">TLS</el-radio>
          <el-radio :label="9">明文</el-radio>
        </el-radio-group>
      </el-form-item>
    </el-form>
    <template #footer>
...
watch(
  () => props.emailDialogTableValue,
  () => {
    console.log(props.emailDialogTableValue);
    form.value = props.emailDialogTableValue;
  },
